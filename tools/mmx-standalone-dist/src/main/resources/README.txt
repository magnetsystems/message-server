...
For more details on Magnet Message, please visit: https://www.magnet.com/developer/magnet-message/
  ...
  Start
  Use a terminal and cd to “~/mmx-standalone-dist-1.10.0-SNAPSHOT“ (for Mac) or the directory that you have unzipped the zip file to instead of “~” (for Linux).
  ...
  Upgrade
  =============================================
  - For Mac, please visit: https://www.magnet.com/developer/magnet-message/downloads/installation-for-mac-osx/
  - For Linux, please visit: https://www.magnet.com/developer/magnet-message/downloads/installation-for-linux/
