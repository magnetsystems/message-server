...
# check jar file
if [ -f /mnt/jenkins/.m2/repository/com/magnet/mmx/mmx-sanity-app/1.4.2/mmx-sanity-app-1.4.2-shaded.jar ]; then
    echo copying jar file
    rm -f mmx-sanity-app-1.4.2-shaded.jar
    cp -f /mnt/jenkins/.m2/repository/com/magnet/mmx/mmx-sanity-app/1.4.2/mmx-sanity-app-1.4.2-shaded.jar .
else
	echo not able to locate mmx-sanity-app-1.4.2-shaded.jar
fi
...
if [ -f heartbeat-prod.props ] && [ -f mmx-sanity-app-1.4.2-shaded.jar ]; then
	...
	rm -f /mnt/jenkins/.m2/repository/com/magnet/mmx/mmx-sanity-app/1.4.2/mmx-sanity-app-1.4.2-shaded.jar
	cp -f mmx-sanity-app-1.4.2-shaded.jar /mnt/jenkins/.m2/repository/com/magnet/mmx/mmx-sanity-app/1.4.2/mmx-sanity-app-1.4.2-shaded.jar
