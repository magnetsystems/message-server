...
public class MessageSenderImplTest {
  ...
  public void testSendWithDeviceIdSpecifiedButNotRecipientId() throws Exception {
    SendMessageRequest request = new SendMessageRequest();
    request.setDeviceId("1.3.8678987654322");
    ...
    String expectedTo = expectedUserId + JIDUtil.APP_ID_DELIMITER + appId.toLowerCase() + "@" + sender.getDomain() + "/" + request.getDeviceId();  //importantuser%aaabsnibkostqst7@localhost/1.3.8678987654322
