...
public class MessageSenderImplTest {
  ...
  @ClassRule
  public static BaseDbTest.DataSourceResource dataSourceRule = new BaseDbTest.DataSourceResource(TestDataSource.USER_DATA_1, TestDataSource.APP_DATA_1, TestDataSource.DEVICE_DATA_1);
