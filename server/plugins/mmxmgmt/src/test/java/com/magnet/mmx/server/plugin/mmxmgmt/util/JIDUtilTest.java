...
public class JIDUtilTest {
  ...
  public void testGetAppId() throws Exception {
    String serialJID = "nexus%i26u1lmv7uc@192.168.101.146/8D2F9E5595E9989FEF3D1.3.6BA0FBE0BB318ED0";
  ...
  public void testGetAppId2() throws Exception {
    String serialJID = "nexus@192.168.101.146/8D2F9E5595E9989FEF3D1.3.6BA0FBE0BB318ED0";
    String appId = JIDUtil.getAppId(serialJID);
    assertNull(appId);
  }
  ...
  public void testGetAppId3() throws Exception {
    String serialJID = "nexus%i26u1lmv7uc192.168.101.146/8D2F9E5595E9989FEF3D1.3.6BA0FBE0BB318ED0";
    String appId = JIDUtil.getAppId(serialJID);
    assertNull(appId);
  }
  ...
  public void testGetResource() throws Exception {
    ...
    String expected = "8D2F9E5595E9989FEF3D1.3.6BA0FBE0BB318ED0";
