...
/**
 * Validates that single value supplied is not null and not empty
 */
public class NotEmptyValueValidator implements SearchValueValidator {
  static final String MISSING_SEARCH_VALUE = "No search value provided.";
