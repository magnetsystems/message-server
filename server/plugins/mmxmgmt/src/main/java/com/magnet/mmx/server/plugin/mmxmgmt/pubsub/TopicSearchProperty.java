 ...
 */
public enum TopicSearchProperty {
   ...
   */
  public static TopicSearchProperty find(String key) {
    if (key == null) {
      return null;
    }
    TopicSearchProperty rv = null;
    TopicSearchProperty[] values = TopicSearchProperty.values();
    int size = values.length;
    for (int i = 0; i < size && rv == null; i++) {
      TopicSearchProperty prop = values[i];
