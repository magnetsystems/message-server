...
/**
 * Post processor for user entity.  It gets the unescaped user ID from the
 * XEP-106 compliant username.
 */
public class UserEntityPostProcessor implements PostProcessor<UserEntity>{
  ...
  public void postProcess(UserEntity instance) {
    ...
    instance.setUsername(JIDUtil.getReadableUserId(username));
  }
}
