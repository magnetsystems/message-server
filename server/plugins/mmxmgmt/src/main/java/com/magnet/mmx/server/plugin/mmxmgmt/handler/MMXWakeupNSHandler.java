...
/**
 * Handle the IQ request from client to issue Wakeup Message (silent
 * notification) message to another client.  The payload should be limited to
 * the built-in PingPong command set.
 */
