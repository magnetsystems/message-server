...
public enum ErrorCode {
  ...
  DEVICE_UPDATE_ERROR(58),
  SEND_MESSAGE_INVALID_RECIPIENT(59),
  SEND_MESSAGE_TOO_BIG(60),
  SEND_MESSAGE_MALFORMED(61),
  AUTH_BAD_TOKEN(62),
  TOPIC_EXISTS(63),
  TOPIC_NOT_EXIST(64),
  TOPIC_SUBSCRIBE_FORBIDDEN(65),
  TOPIC_ALREADY_SUBSCRIBED(66),
  ...
  SEND_MESSAGE_TOO_MANY_TARGETS(73),
  NOT_FOUND(74),
  ;
