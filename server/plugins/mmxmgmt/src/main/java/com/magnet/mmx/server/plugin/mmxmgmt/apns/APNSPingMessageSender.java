...
/**
 */
public class APNSPingMessageSender  extends APNSPushMessageSender {

  public APNSPingMessageSender(AppEntity appEntity, Options options) {
    super(appEntity, options);
  }

  public APNSPingMessageSender(AppEntity appEntity) {
    super(appEntity);
  }

  @Override
  protected void writePushMessage(PushMessageDAO pushMessageDAO, String messageId, String appId, String deviceId) {
    writePushMessage(pushMessageDAO, messageId, appId, deviceId, PushMessageEntity.PushMessageType.API_PING);
  }
