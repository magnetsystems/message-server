...
/**
 */
public class GCMPingMessageSender extends GCMPushMessageSender {
  public GCMPingMessageSender(AppEntity appEntity, Options options) {
    super(appEntity, options);
  }

  public GCMPingMessageSender(AppEntity appEntity) {
    super(appEntity);
  }

  @Override
  protected void writePushMessage(PushMessageDAO pushMessageDAO, String messageId, String appId, String deviceId) {
    this.writePushMessage(pushMessageDAO, messageId, appId, deviceId, PushMessageEntity.PushMessageType.API_PING);
  }
}
