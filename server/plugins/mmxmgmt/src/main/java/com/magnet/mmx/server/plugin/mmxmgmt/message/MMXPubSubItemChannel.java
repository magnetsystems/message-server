 ...
 */
@XmlRootElement
@XmlType(propOrder={"appId", "channelName", "itemId", "meta", "payload"})
@JsonInclude(JsonInclude.Include.NON_NULL)
public class MMXPubSubItemChannel {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof MMXPubSubItemChannel)) return false;
